...
class Admin extends CI_Controller {
	...
	public function initiatives_scrapper_true() {
		try {
			...
			/*Columnas*/
			$crud->columns('id_initiative', 'id_legislature', 'titulo_listado', 'fecha_listado', 'fecha_votacion', 'periodo', 'presentada', 'enviada', 'commissions2initiatives', 'initiatives2topics', 'revisada');
